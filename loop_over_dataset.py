...
exec_detection = ['pcl_from_rangeimage','bev_from_pcl','detect_objects'] # options are 'bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance'; options not in the list will be loaded from file
...
while True:
    try:
        ...
        if (configs_det.use_labels_as_objects==True):
            ...
            if 'detect_objects' in exec_list:
                ...
                if 'perform_tracking' in exec_list:
                    ...
                    detections = load_object_from_file(results_fullpath, data_filename, 'detections_' + 'fpn_resnet_0.5', cnt_frame)
        ...
        if 'measure_detection_performance' in exec_list:
            ...
            # else:
                # det_performance = load_object_from_file(results_fullpath, data_filename, 'det_performance_' + 'fpn_resnet_0.5', cnt_frame)   
